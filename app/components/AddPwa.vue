      ...
      <div class="install-popup" @click.stop>
        ...
        <div v-if="isAndroidDevice" class="popup-content">
          ...
          <p class="popup-description">
            Adicione o <strong>Popular Card</strong> à sua tela inicial para acesso rápido e uma experiência completa!
          </p>
        ...
        <div v-if="isIOSDevice" class="popup-content ios-content">
          <h2 class="popup-title">Instale o App</h2>
          <p class="popup-description">
            Siga os passos abaixo para adicionar <strong>Popular Card</strong> à sua tela inicial
          </p>
              ...
              <div class="carousel-slide">
                ...
                <div class="step-illustration">
                  <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
                    ...
                    <text x="60" y="70" font-size="8" fill="#333" text-anchor="middle" font-weight="600">Popular Card</text>
